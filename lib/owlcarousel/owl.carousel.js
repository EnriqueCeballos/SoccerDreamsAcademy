...
(function ($, window, document, undefined) {
  ...
  function Owl(element, options) {
    ...
    /**
     * Currently suppressedEvents to prevent them from beeing retriggered.
     * @protected
     */
    this._supress = {};
   ...
   * SuppressesEvents.
   * @protected
   * @param {Array.<String>}Events - TheEvents to suppress.
   */
  ...
  /**
   * Releases suppressedEvents.
   * @protected
   * @param {Array.<String>}Events - TheEvents to release.
   */
...
(function ($, window, document, undefined) {
  ...
  Navigation.prototype.draw = function () {
    ...
    if (settings.dots) {
      difference =
        this._Events.length - this._controls.$absolute.children().length;
      ...
      this._controls.$absolute
        .children()
        .eq($.inArray(this.current(), this._Events))
        .addClass("active");
    }
  };
  ...
  Navigation.prototype.onTrigger = function (event) {
    ...
    event.page = {
      index: $.inArray(this.current(), this._Events),
  ...
  Navigation.prototype.getPosition = function (successor) {
    ...
    if (settings.slideBy == "page") {
      position = $.inArray(this.current(), this._Events);
      length = this._Events.length;
      successor ? ++position : --position;
      position = this._Events[((position % length) + length) % length].start;
    } else {
  ...
  Navigation.prototype.to = function (position, speed, standard) {
    ...
    if (!standard && this._Events.length) {
      length = this._Events.length;
      $.proxy(this._overrides.to, this._core)(
        this._Events[((position % length) + length) % length].start,
        speed
      );
    } else {
